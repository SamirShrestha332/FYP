...
function RecruiterForgotPassword() {
    ...
    useEffect(() => {
        ...
        if (location.state && location.state.email) {
            ...
            const storedEmail = localStorage.getItem('lastRecruiterEmail');
            if (storedEmail) {
    ...
    const handleVerifyOtp = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:5000/api/recruiter/verify-reset-otp', { 
                email, 
                otp 
            });
    ...
    const handleResetPassword = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:5000/api/recruiter/reset-password', {
                email,
                otp,
                newPassword
            });
    ...
    return (
        <div className="recruiter-auth-container">
            <div className="recruiter-auth-card">
                ...
                {success && <div className="recruiter-success-message">{success}</div>}
                
                {step === 1 && (
                    <form className="recruiter-auth-form" onSubmit={handleRequestOtp}>
                ...
                {step === 2 && (
                    <form className="recruiter-auth-form" onSubmit={handleVerifyOtp}>
                        <div className="form-group">
                        ...
                        <div className="recruiter-resend-otp">
                            <button 
                                type="button" 
                                className="recruiter-resend-btn" 
                ...
                {step === 3 && (
                    <form className="recruiter-auth-form" onSubmit={handleResetPassword}>
                        <div className="form-group">
                ...
                <div className="recruiter-auth-footer">
                    Remember your password? <Link to="/recruiter/login">Sign in</Link>
                </div>
            </div>
